...
class CreateVectorTile(PBPTQProcessTool):
    ...
    def do_processing(self, **kwargs):
        pxl_count = rsgislib.imagecalc.count_pxls_of_val(self.params['img_tile'], vals=[1, 2])
        ...
        if tot_pxl_count > 0:
            ...
            pxl_val_col = rsgislib.vectorattrs.read_vec_column(self.params['out_vec'], self.params['out_lyr_name'], "chng_type_id")
            out_vals = list()
            ...
            rsgislib.vectorattrs.write_vec_column(self.params['out_vec'], self.params['out_lyr_name'], "chng_type", ogr.OFTString, out_vals)
