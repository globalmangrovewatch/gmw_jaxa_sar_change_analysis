...
class GenTileExtentCmds(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        for gmw_tile in gmw_tiles:
            ...
            out_img = os.path.join(kwargs['out_path'], f"{tile_base_name}.tif")
    ...
    def run_gen_commands(self):
        ...
        self.gen_command_info(gmw_tiles='/scratch/a.pfb/gmw_v3_change/data/gmw_baseline/gmw_2010_v3/*.kea',
                              out_path='/scratch/a.pfb/gmw_v3_change/data/gmw_baseline/gmw_2010_v25_tif')

        self.pop_params_db()
        self.create_slurm_sub_sh("v25_gtiff", 8224, '/scratch/a.pfb/gmw_v3_change/logs',
...
if __name__ == "__main__":
    ...
    create_tools = GenTileExtentCmds(cmd=script_cmd, db_conn_file="/home/a.pfb/gmw_gap_fill_db/pbpt_db_conn.txt",
                                         lock_file_path="./gmw_hab_lock_file.txt",
