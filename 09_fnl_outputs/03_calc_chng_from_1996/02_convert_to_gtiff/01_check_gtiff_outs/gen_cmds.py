    ...
    def run_gen_commands(self):
        ...
        for year in years:
            self.gen_command_info(imgs_dir='/scratch/a.pfb/gmw_v3_change/data/fnl_v3_prods/gmw_chngs/gmw_v3_f1996_t{}_v312_kea/*.kea'.format(year),
                                  tif_dir='/scratch/a.pfb/gmw_v3_change/data/fnl_v3_prods/gmw_chngs/gmw_v3_f1996_t{}_v312'.format(year),
                                  out_dir='/scratch/a.pfb/gmw_v3_change/data/fnl_v3_prods/gmw_chngs/gmw_v3_f1996_t{}_v312_chkd'.format(year))
