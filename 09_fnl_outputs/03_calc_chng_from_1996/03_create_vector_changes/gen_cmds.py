...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def run_gen_commands(self):
        ...
        for year in years:
            self.gen_command_info(img_srch='/scratch/a.pfb/gmw_v3_change/data/fnl_v3_prods/gmw_chngs/gmw_v3_f1996_t{}_v314_kea/*.kea'.format(year),
                                  out_lyr_name='gmw_chng_f1996_t{}'.format(year),
                                  out_dir='/scratch/a.pfb/gmw_v3_change/data/fnl_v3_prods/gmw_chngs/gmw_v3_f1996_t{}_v314_vecs'.format(year))
