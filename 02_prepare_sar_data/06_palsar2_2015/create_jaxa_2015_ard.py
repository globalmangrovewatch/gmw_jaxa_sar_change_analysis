...
class Create2015PALSAR2ARD(PBPTQProcessTool):

    def __init__(self):
        super().__init__(cmd_name='create_jaxa_2015_ard.py', descript=None)
    ...
    def do_processing(self, **kwargs):
        ...
        hv_dB_file = os.path.join(self.params['tmp_dir'], '{}_2015_hv_dB.kea'.format(self.params['tile']))
        ...
        # Stack Image bands
        #sar_stack_file = os.path.join(self.params['tmp_dir'], '{}_palsar_2015_dB.kea'.format(self.params['tile']))
