...
class Create2017PALSAR2ARD(PBPTQProcessTool):

    def __init__(self):
        super().__init__(cmd_name='create_jaxa_2017_ard.py', descript=None)
    ...
    def do_processing(self, **kwargs):
        ...
        hh_dB_file = os.path.join(self.params['tmp_dir'], '{}_2017_hh_dB.kea'.format(self.params['tile']))
        rsgislib.imagecalc.imageMath(hh_file, hh_dB_file, '(10 * log10(b1^2) - 83.0)*100', 'KEA', rsgislib.TYPE_16INT)

        hv_dB_file = os.path.join(self.params['tmp_dir'], '{}_2017_hv_dB.kea'.format(self.params['tile']))
        ...
        # Stack Image bands
        # sar_stack_file = os.path.join(self.params['tmp_dir'], '{}_palsar_2017_dB.kea'.format(self.params['tile']))
