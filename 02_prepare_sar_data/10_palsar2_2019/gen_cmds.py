...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        for arch_file in in_archives:
            ...
            sar_img = os.path.join(out_dir, '{}_2019_db.kea'.format(tile_name))
            date_img = os.path.join(out_dir, '{}_2019_dates.kea'.format(tile_name))
            vmsk_img = os.path.join(out_dir, '{}_2019_vmsk.kea'.format(tile_name))
            linci_img = os.path.join(out_dir, '{}_2019_linci.kea'.format(tile_name))
            ...
            if (not os.path.exists(sar_img)) or (not os.path.exists(date_img)) or (not os.path.exists(vmsk_img)) or (not os.path.exists(linci_img)):
                ...
                c_dict['tmp_dir'] = os.path.join(kwargs['tmp_dir'], "{}_2019_ard".format(tile_name))
    ...
    def run_gen_commands(self):
        ...
        self.pop_params_db()
        self.create_slurm_sub_sh("gen_2019_jaxa_ard", 16448, '/scratch/a.pfb/gmw_v3_change/logs',
...
if __name__ == "__main__":
    py_script = os.path.abspath("create_jaxa_2019_ard.py")
    script_cmd = "singularity exec --bind /scratch/a.pfb:/scratch/a.pfb --bind /home/a.pfb:/home/a.pfb /scratch/a.pfb/sw_imgs/au-eoed-dev.sif python {}".format(py_script)

    process_tools_mod = 'create_jaxa_2019_ard'
    process_tools_cls = 'Create2019PALSAR2ARD'
