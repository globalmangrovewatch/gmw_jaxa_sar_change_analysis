...
class Create2019PALSAR2ARD(PBPTQProcessTool):

    def __init__(self):
        super().__init__(cmd_name='create_jaxa_2019_ard.py', descript=None)
    ...
    def do_processing(self, **kwargs):
        ...
        hh_p2_file_pattern = '*_sl_HH_F02DAR.tif'
        hv_p2_file_pattern = '*_sl_HV_F02DAR.tif'

        mask_file_pattern = '*_mask_F02DAR.tif'
        date_file_pattern = '*_date_F02DAR.tif'
        linci_file_pattern = '*_linci_F02DAR.tif'

        hh_p2_fp_file_pattern = '*_sl_HH_FP6QAR.tif'
        hv_p2_fp_file_pattern = '*_sl_HV_FP6QAR.tif'

        mask_fp_file_pattern = '*_mask_FP6QAR.tif'
        date_fp_file_pattern = '*_date_FP6QAR.tif'
        linci_fp_file_pattern = '*_linci_FP6QAR.tif'
        ...
        hh_dB_file = os.path.join(self.params['tmp_dir'], '{}_2019_hh_dB.kea'.format(self.params['tile']))
        rsgislib.imagecalc.imageMath(hh_file, hh_dB_file, '(10 * log10(b1^2) - 83.0)*100', 'KEA', rsgislib.TYPE_16INT)

        hv_dB_file = os.path.join(self.params['tmp_dir'], '{}_2019_hv_dB.kea'.format(self.params['tile']))
        ...
        # Stack Image bands
        # sar_stack_file = os.path.join(self.params['tmp_dir'], '{}_palsar_2019_dB.kea'.format(self.params['tile']))
