...
class Create1996JERS1ARD(PBPTQProcessTool):

    def __init__(self):
        super().__init__(cmd_name='create_jaxa_1996_ard.py', descript=None)
    ...
    def do_processing(self, **kwargs):
        ...
        try:
            hh_file = rsgis_utils.findFile(extract_data_dir, hh_jers1_file_pattern)
        except Exception as e:
            print("Could not find HH file in '{}'".format(extract_data_dir))
            raise e

        rsgislib.imagecalc.imageMath(hh_file, self.params['sar_img'], '(10 * log10(b1^2) - 84.66)*100', 'KEA', rsgislib.TYPE_16INT)
