...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        for gmw_tile in img_tiles:
            ...
            if os.path.exists(sar_img):
                out_img = os.path.join(sar_scn_dir, '{}_{}_bin_vmsk.kea'.format(tile_name, kwargs['sar_year']))
    ...
    def run_gen_commands(self):
        ...
        self.pop_params_db()
        self.create_slurm_sub_sh("gmw_sar_bin_vmsks", 16448, '/scratch/a.pfb/gmw_v3_change/logs',
