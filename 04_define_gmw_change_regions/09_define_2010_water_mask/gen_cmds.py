...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        for gmw_tile in img_tiles:
            ...
            water_occur_img = os.path.join(kwargs['water_occur_dir'], '{}_water_occur.kea'.format(tile_basename))
            sar_img = os.path.join(sar_scn_dir, '{}_2010_db.kea'.format(tile_name))
            if not os.path.exists(sar_img):
                sar_img = None

            out_img = os.path.join(kwargs['out_dir'], '{}_2010_water_mask.kea'.format(tile_basename))
            ...
            if (not os.path.exists(out_img)):
                ...
                c_dict['tmp_dir'] = os.path.join(kwargs['tmp_dir'], "{}_2010_water_mask".format(tile_basename))
    ...
    def run_gen_commands(self):
        ...
        self.pop_params_db()
        self.create_slurm_sub_sh("gmw_2010_water_msk", 16448, '/scratch/a.pfb/gmw_v3_change/logs',
