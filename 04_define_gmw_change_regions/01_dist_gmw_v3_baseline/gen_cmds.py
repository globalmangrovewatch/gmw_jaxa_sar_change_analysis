...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        for gmw_tile in img_tiles:
            ...
            gmw_dist_regions_img = os.path.join(kwargs['out_tiles_dir'], '{}_dist_pxls.kea'.format(basename))

            if (not os.path.exists(gmw_dist_regions_img)):
                c_dict = dict()
                c_dict['tile'] = tile_basename
                c_dict['gmw_tile'] = gmw_tile
                c_dict['out_img'] = gmw_dist_regions_img
                self.params.append(c_dict)


    def run_gen_commands(self):
        self.gen_command_info(in_tiles_path='/scratch/a.pfb/gmw_v2_gapfill/data/gmw_tiles/gmw_init_v3_qa/*.kea',
                              out_tiles_dir='/scratch/a.pfb/gmw_v3_change/data/gmw_baseline/gmw_v3_init_dist',
...
if __name__ == "__main__":
    py_script = os.path.abspath("dist_to_gmw_regions.py")
    script_cmd = "singularity exec --bind /scratch/a.pfb:/scratch/a.pfb --bind /home/a.pfb:/home/a.pfb /scratch/a.pfb/sw_imgs/au-eoed-dev.sif python {}".format(py_script)

    process_tools_mod = 'dist_to_gmw_regions'
    process_tools_cls = 'DistGMWRegions'
