...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        for gmw_tile in img_tiles:
            ...
            pot_ocean_chng_img = os.path.join(kwargs['pot_jaxa_chng_tiles_dir'], '{}_pot_chng_ocean_chg_rgns.kea'.format(tile_basename))
            ...
            if (not os.path.exists(out_img)):
                ...
                c_dict['pot_ocean_chng'] = pot_ocean_chng_img
                c_dict['pot_sar_chng'] = pot_sar_chng_img
    ...
    def run_gen_commands(self):
        ...
        self.pop_params_db()
        self.create_slurm_sub_sh("pot_gmw_chng_ocean_chg_rgns", 16448, '/scratch/a.pfb/gmw_v3_change/logs',
