...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        for gmw_tile in img_tiles:
            ...
            if (not os.path.exists(gmw_rmsml_chng_rgns_img)):
                print("rm {}".format(gmw_pot_chng_rgns_img))
                c_dict = dict()
                c_dict['tile'] = tile
                c_dict['gmw_tile'] = gmw_tile
                c_dict['gmw_pot_chng_rgns_img'] = gmw_pot_chng_rgns_img
                c_dict['gmw_rmsml_chng_rgns_img'] = gmw_rmsml_chng_rgns_img
                c_dict['tmp_dir'] = os.path.join(kwargs['tmp_dir'], "{}_rmsml_chng_rgns".format(tile_basename))
    ...
    def run_gen_commands(self):
        self.gen_command_info(in_tiles_path='/scratch/a.pfb/gmw_v2_gapfill/data/gmw_tiles/gmw_init_v3_further_qa_part2/*.kea',
                              init_potent_chng='/scratch/a.pfb/gmw_v3_change/data/gmw_baseline/gmw_v3_init_change_regions',
                              out_tiles_dir='/scratch/a.pfb/gmw_v3_change/data/gmw_baseline/gmw_v3_init_change_regions_rm_sml',
                              tmp_dir='/scratch/a.pfb/gmw_v3_change/tmp')
        self.pop_params_db()
        self.create_slurm_sub_sh("rm_small_feats", 16448, '/scratch/a.pfb/gmw_v3_change/logs',
...
if __name__ == "__main__":
    py_script = os.path.abspath("rm_small_feats.py")
    script_cmd = "singularity exec --bind /scratch/a.pfb:/scratch/a.pfb --bind /home/a.pfb:/home/a.pfb /scratch/a.pfb/sw_imgs/au-eoed-dev.sif python {}".format(py_script)

    process_tools_mod = 'rm_small_feats'
    process_tools_cls = 'RMSmallPotentChangeFeatures'
