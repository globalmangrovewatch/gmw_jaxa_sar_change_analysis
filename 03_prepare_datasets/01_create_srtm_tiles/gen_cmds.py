...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def run_gen_commands(self):
        self.gen_command_info(lut_file='/scratch/a.pfb/gmw_v3_change/data/other_base_data/global_srtm_lut.gpkg',
                              lut_lyr='srtm',
                              gmw_tiles='/scratch/a.pfb/gmw_v2_gapfill/data/gmw_tiles/gmw_init_v3_qa/*.kea',
                              out_tiles_dir='/scratch/a.pfb/gmw_v3_change/data/other_base_data/srtm_gmw_tiles',
                              tmp_dir='/scratch/a.pfb/gmw_v3_change/tmp')
        self.pop_params_db()
        self.create_slurm_sub_sh("srtm_gmw_tiles", 16448, '/scratch/a.pfb/gmw_v3_change/logs',
