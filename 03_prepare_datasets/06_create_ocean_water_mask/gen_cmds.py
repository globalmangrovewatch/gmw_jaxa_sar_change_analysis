...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        for gmw_tile in img_tiles:
            ...
            water_occur_img = os.path.join(kwargs['water_occur_tiles_dir'], '{}_water_occur.kea'.format(tile_basename))

            out_img = os.path.join(kwargs['out_dir'], '{}_ocean_water.kea'.format(tile_basename))
            ...
            if (not os.path.exists(out_img)):
                ...
                c_dict['water_occur_img'] = water_occur_img
                c_dict['out_img'] = out_img
                c_dict['tmp_dir'] = os.path.join(kwargs['tmp_dir'], "{}_ocean_water_tile".format(tile_basename))
    ...
    def run_gen_commands(self):
        self.gen_command_info(gmw_tiles='/scratch/a.pfb/gmw_v2_gapfill/data/gmw_tiles/gmw_init_v3_qa/*.kea',
                              ...
                              water_occur_tiles_dir='/scratch/a.pfb/gmw_v3_change/data/other_base_data/water_occurance_gmw_tiles',
                              out_dir='/scratch/a.pfb/gmw_v3_change/data/other_base_data/ocean_water_tiles',
                              tmp_dir='/scratch/a.pfb/gmw_v3_change/tmp')
        self.pop_params_db()
        self.create_slurm_sub_sh("ocean_water_tiles", 16448, '/scratch/a.pfb/gmw_v3_change/logs',
