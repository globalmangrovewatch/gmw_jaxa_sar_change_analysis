...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        for gmw_tile in img_tiles:
            ...
            out_img = os.path.join(kwargs['out_dir'], '{}_gmw_v2_union.kea'.format(tile_basename))
    ...
    def run_gen_commands(self):
        self.gen_command_info(gmw_tiles='/scratch/a.pfb/gmw_v2_gapfill/data/gmw_tiles/gmw_init_v3_qa/*.kea',
                              vec_file='/scratch/a.pfb/gmw_v3_change/data/GMW_v2_Change.gpkg',
                              vec_lyr='union_gmw',
                              out_dir='/scratch/a.pfb/gmw_v3_change/data/other_base_data/gmw_v2_union')
        self.pop_params_db()
        self.create_slurm_sub_sh("gmw_v2_union", 16448, '/scratch/a.pfb/gmw_v3_change/logs',
