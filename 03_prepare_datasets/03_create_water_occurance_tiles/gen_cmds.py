...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        for gmw_tile in img_tiles:
            ...
            gmw_water_occur_img = os.path.join(kwargs['out_tiles_dir'], '{}_water_occur.kea'.format(tile_basename))
            ...
            if (not os.path.exists(gmw_water_occur_img)):
                ...
                c_dict['tmp_dir'] = os.path.join(kwargs['tmp_dir'], "{}_water_occur_tile".format(tile_basename))
    ...
    def run_gen_commands(self):
        self.gen_command_info(lut_file='/scratch/a.pfb/gmw_v3_change/data/other_base_data/global_water_occurance_lut.gpkg',
                              lut_lyr='water_occurance',
                              gmw_tiles='/scratch/a.pfb/gmw_v2_gapfill/data/gmw_tiles/gmw_init_v3_qa/*.kea',
                              out_tiles_dir='/scratch/a.pfb/gmw_v3_change/data/other_base_data/water_occurance_gmw_tiles',
                              tmp_dir='/scratch/a.pfb/gmw_v3_change/tmp')
        self.pop_params_db()
        self.create_slurm_sub_sh("water_occurance_gmw_tiles", 16448, '/scratch/a.pfb/gmw_v3_change/logs',
