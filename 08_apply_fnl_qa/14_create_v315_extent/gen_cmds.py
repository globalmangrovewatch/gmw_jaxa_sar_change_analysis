...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        for gmw_tile in img_tiles:
            ...
            for year in kwargs['years']:
                ...
                out_imgs[year] = os.path.join(out_dir, "{}_{}_mjr_v315.kea".format(tile_basename, year))
            ...
            if not out_files_exist:
                ...
                c_dict['tmp_dir'] = os.path.join(kwargs['tmp_dir'], "{}_mjr_v315".format(tile_basename))
    ...
    def run_gen_commands(self):
        self.gen_command_info(gmw_tiles_dir = '/scratch/a.pfb/gmw_v3_change/data/gmw_chng_data/gmw_v3_fnl_mjr_{}_v313',
                              ...
                              out_dir='/scratch/a.pfb/gmw_v3_change/data/gmw_chng_data/gmw_v3_fnl_mjr_{}_v315',
                              tmp_dir='/scratch/a.pfb/gmw_v3_change/tmp')
        
        self.pop_params_db()
        self.create_slurm_sub_sh("gen_gmw_v315", 16448, '/scratch/a.pfb/gmw_v3_change/logs',
