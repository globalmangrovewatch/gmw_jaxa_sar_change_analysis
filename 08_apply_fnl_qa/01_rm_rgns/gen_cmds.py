...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        for gmw_tile in img_tiles:
            ...
            if not os.path.exists(out_img):
                ...
                c_dict['qa_file'] = kwargs['qa_file']
                c_dict['qa_lyr'] = kwargs['qa_lyr']
    ...
    def run_gen_commands(self):
        ...
        for year in years:
            gmw_tiles = '/scratch/a.pfb/gmw_v3_change/data/gmw_chng_data/gmw_v3_mng_mjr_ext_{}_tpflt/*.kea'.format(year)
            if (year == '1996') or (year == '2020'):
                gmw_tiles = '/scratch/a.pfb/gmw_v3_change/data/gmw_chng_data/gmw_v3_mng_mjr_ext_{}/*.kea'.format(year)

            self.gen_command_info(gmw_tiles=gmw_tiles,
                                  year=year,
                                  qa_file='gmw_v3_qa_rm_rgns.geojson',
                                  qa_lyr='gmw_v3_qa_rm_rgns',
                                  out_dir='/scratch/a.pfb/gmw_v3_change/data/gmw_chng_data/gmw_v3_fnl_mjr_{}_v309'.format(year),
                                  tmp_dir='/scratch/a.pfb/gmw_v3_change/tmp')
        
        self.pop_params_db()
        self.create_slurm_sub_sh("gmw_apply_qa_fnl", 16448, '/scratch/a.pfb/gmw_v3_change/logs',
