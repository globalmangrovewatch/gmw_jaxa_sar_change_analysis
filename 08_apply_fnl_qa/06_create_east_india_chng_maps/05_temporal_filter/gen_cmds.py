...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        for gmw_tile in img_tiles:
            ...
            pre_gmw_img = os.path.join(kwargs['pre_tiles_dir'], '{}_east_india_gmw_extent.kea'.format(tile_basename))
            post_gmw_img = os.path.join(kwargs['post_tiles_dir'], '{}_east_india_gmw_extent.kea'.format(tile_basename))
    ...
    def run_gen_commands(self):
        ...
        for year_idx in range(len(years)):
            ...
            if year == '1996':
                ...
                self.gen_command_info(gmw_tiles='/scratch/a.pfb/gmw_v3_change/data/gmw_east_india_edits/gmw_v3_east_india_chgns/{}/*.kea'.format(year),
                                      year=year,
                                      pre_year=pre_year,
                                      post_year=post_year,
                                      pre_tiles_dir='/scratch/a.pfb/gmw_v3_change/data/gmw_east_india_edits/gmw_v3_east_india_chgns/{}'.format(pre_year),
                                      post_tiles_dir='/scratch/a.pfb/gmw_v3_change/data/gmw_east_india_edits/gmw_v3_east_india_chgns/{}'.format(post_year),
                                      out_dir='/scratch/a.pfb/gmw_v3_change/data/gmw_chng_data/gmw_v3_east_india_chgns_tpflt/{}'.format(year))
