    ...
    def run_gen_commands(self):
        ...
        for year in years:
            ...
            self.gen_command_info(gmw_tiles='/scratch/a.pfb/gmw_v3_change/data/gmw_chng_data/gmw_v3_fnl_mjr_{}_v309/*.kea'.format(year),
                                  year=year,
                                  india_tiles_dir=india_tiles_dir,
                                  out_dir='/scratch/a.pfb/gmw_v3_change/data/gmw_chng_data/gmw_v3_fnl_mjr_{}_v310/'.format(year))

        self.pop_params_db()
        self.create_slurm_sub_sh("merge_east_india_into_gmw", 16448, '/scratch/a.pfb/gmw_v3_change/logs',
