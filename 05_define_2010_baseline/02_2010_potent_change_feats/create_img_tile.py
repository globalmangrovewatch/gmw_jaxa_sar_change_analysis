...
class CreateImageTile(PBPTQProcessTool):
    ...
    def do_processing(self, **kwargs):
        band_defns = [rsgislib.imagecalc.BandDefn('wmsk', self.params['water_msk_img'], 1),
                      rsgislib.imagecalc.BandDefn('wchng', self.params['water_chng_img'], 1),
        ...
        rsgislib.imagecalc.bandMath(self.params['out_img'], '(gmwinit==1)&&(gmw==0)?1:(pchng==1)&&(wmsk==1)&&(wchng!=100)?1:0', 'KEA', rsgislib.TYPE_8UINT, band_defns)
