...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        for gmw_tile in img_tiles:
            ...
            water_chng_img = os.path.join(kwargs['water_change_dir'], '{}_water_change.kea'.format(tile_basename))
            ...
            if (not os.path.exists(out_img)):
                ...
                c_dict['water_chng_img'] = water_chng_img
    ...
    def run_gen_commands(self):
        self.gen_command_info(gmw_tiles='/scratch/a.pfb/gmw_v3_change/data/gmw_baseline/gmw_2010_v3/*.kea',
                              ...
                              water_change_dir='/scratch/a.pfb/gmw_v3_change/data/other_base_data/water_change_gmw_tiles',
