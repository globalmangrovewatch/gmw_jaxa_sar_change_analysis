...
rsgislib.vectorutils.mergeVectors2GPKG(input_vecs, out_file, "gmw_2010_potent_chng", True)
...
rsgislib.vectorutils.mergeVectors2GPKG(input_vecs, out_file, "gmw_2010_potent_chng_stats_rgns", True)
