...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def run_gen_commands(self):
        ...
        self.gen_command_info(
            img_srch='/scratch/a.pfb/gmw_v3_change/data/gmw_chng_data/gmw_2010_2010_chngs/*2010_mng_chng.kea',
            out_lyr_name='gmw_mng_chng',
            out_dir='/scratch/a.pfb/gmw_v3_change/data/gmw_chng_data/gmw_2010_2010_chngs_vecs/')

        self.gen_command_info(
            img_srch='/scratch/a.pfb/gmw_v3_change/data/gmw_chng_data/gmw_2010_2010_chngs/*2010_not_mng_chng.kea',
            out_lyr_name='gmw_nmng_chng',
            out_dir='/scratch/a.pfb/gmw_v3_change/data/gmw_chng_data/gmw_2010_2010_chngs_vecs/')


        self.pop_params_db()
        self.create_slurm_sub_sh("gmw_2010_chngs_msk_vecs", 16448, '/scratch/a.pfb/gmw_v3_change/logs',
