...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        prj_thresholds_lut = rsgis_utils.readJSON2Dict(kwargs['thres_file'])
        ...
        for gmw_tile in img_tiles:
            ...
            prj_thresholds = prj_thresholds_lut[gmw_prj]
            ...
            if  not out_files_present:
                ...
                c_dict['prj_thresholds'] = prj_thresholds
    ...
    def run_gen_commands(self):
        ...
        self.pop_params_db()
        self.create_slurm_sub_sh("gmw_2010_2010_chngs", 16448, '/scratch/a.pfb/gmw_v3_change/logs',
