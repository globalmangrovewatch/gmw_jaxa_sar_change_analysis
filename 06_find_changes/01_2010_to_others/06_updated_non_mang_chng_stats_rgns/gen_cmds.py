    ...
    def gen_command_info(self, **kwargs):
        ...
        for gmw_tile in img_tiles:
            ...
            if not os.path.exists(out_img):
                print("rm {}".format(chng_stats_rgns_img))
                c_dict = dict()
                c_dict['tile'] = tile_basename
                c_dict['gmw_tile'] = gmw_tile
                c_dict['year'] = kwargs['sar_year']
                c_dict['chng_stats_rgns_img'] = chng_stats_rgns_img
                c_dict['mng_chng_img'] = mng_chng_img
                c_dict['nmng_chng_img'] = nmng_chng_img
                c_dict['out_img'] = out_img
                c_dict['tmp_dir'] = os.path.join(kwargs['tmp_dir'], "{}_{}_update_chng_stats_layers".format(tile_basename, kwargs['sar_year']))
    ...
    def run_gen_commands(self):
        ...
        for year in ['1996', '2007', '2008', '2009', '2015', '2016', '2017', '2018', '2019', '2020']:
            self.gen_command_info(gmw_tiles='/scratch/a.pfb/gmw_v3_change/data/gmw_baseline/gmw_2010_v3/*.kea',
                                  ...
                                  pchg_stats_msk_dir='/scratch/a.pfb/gmw_v3_change/data/gmw_baseline/gmw_2010_fnl_potent_stats_rgn',
                                  sar_year=year,
                                  out_dir='/scratch/a.pfb/gmw_v3_change/data/gmw_chng_data/from2010/gmw_base2010_pchg_stats_rgns_{}_v3'.format(year),
