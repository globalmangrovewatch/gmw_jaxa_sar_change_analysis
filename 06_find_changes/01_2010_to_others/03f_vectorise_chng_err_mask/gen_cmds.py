...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def run_gen_commands(self):
        self.gen_command_info(
            img_srch='/scratch/a.pfb/gmw_v3_change/data/gmw_chng_data/gmw_chngs_err_msk/*.kea',
            out_lyr_name='gmw_chngs_err_msk',
            out_dir='/scratch/a.pfb/gmw_v3_change/data/gmw_chng_data/gmw_chngs_err_msk_vecs')

        self.pop_params_db()
        self.create_slurm_sub_sh("gmw_chngs_err_msk_vecs", 16448, '/scratch/a.pfb/gmw_v3_change/logs',
