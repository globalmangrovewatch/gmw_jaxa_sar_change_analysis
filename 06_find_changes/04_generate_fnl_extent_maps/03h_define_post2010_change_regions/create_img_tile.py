...
class CreateImageTile(PBPTQProcessTool):
    ...
    def do_processing(self, **kwargs):
        ...
        rsgislib.imagecalc.bandMath(self.params['out_img'], 'errmsk==1?0:chg', 'KEA', rsgislib.TYPE_8UINT, band_defns)
    ...
    def required_fields(self, **kwargs):
        return ["tile", "chng_img", "chng_err_msk_img", "out_img", "tmp_dir"]
