...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def run_gen_commands(self):
        self.gen_command_info(gmw_tiles='/scratch/a.pfb/gmw_v3_change/data/gmw_baseline/gmw_2010_v3/*.kea',
                              ...
                              sar_year='1996',
                              out_dir='/scratch/a.pfb/gmw_v3_change/data/gmw_chng_data/gmw_2010_1996_pxl_vals')
        self.pop_params_db()
        self.create_slurm_sub_sh("gmw_2010_1996_pxl_vals", 16448, '/scratch/a.pfb/gmw_v3_change/logs',
