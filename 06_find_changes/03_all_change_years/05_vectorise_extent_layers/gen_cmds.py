        ...
        for l1_year in years_l1:
            ...
            for chg_year in chng_years:
                self.gen_command_info(
                    img_srch=os.path.join(base_dir, 'gmw_base{}_{}_mng_ext/*.kea'.format(l1_year, chg_year)),
                    out_lyr_name='mng_{}'.format(chg_year),
                    out_dir=os.path.join(base_dir, 'gmw_base{}_{}_mng_ext_vecs'.format(l1_year, chg_year)))

        self.pop_params_db()
        self.create_slurm_sub_sh("calc_annual_mng_ext_vecs", 16448, '/scratch/a.pfb/gmw_v3_change/logs',
