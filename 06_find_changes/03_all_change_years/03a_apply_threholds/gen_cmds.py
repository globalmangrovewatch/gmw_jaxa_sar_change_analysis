...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        for gmw_tile in img_tiles:
            ...
            out_mng_chng = os.path.join(kwargs['out_dir'], '{}_{}_mng_chng_base{}.kea'.format(tile_basename, kwargs['sar_year'], kwargs['base_year']))
            out_nmng_chng = os.path.join(kwargs['out_dir'], '{}_{}_not_mng_chng_base{}.kea'.format(tile_basename, kwargs['sar_year'], kwargs['base_year']))

            out_mng_chng_upper = os.path.join(kwargs['out_dir'], '{}_{}_mng_chng_upper_base{}.kea'.format(tile_basename, kwargs['sar_year'], kwargs['base_year']))
            out_nmng_chng_upper = os.path.join(kwargs['out_dir'], '{}_{}_not_mng_chng_upper_base{}.kea'.format(tile_basename, kwargs['sar_year'], kwargs['base_year']))

            out_mng_chng_lower = os.path.join(kwargs['out_dir'], '{}_{}_mng_chng_lower_base{}.kea'.format(tile_basename, kwargs['sar_year'], kwargs['base_year']))
            out_nmng_chng_lower = os.path.join(kwargs['out_dir'], '{}_{}_not_mng_chng_lower_base{}.kea'.format(tile_basename, kwargs['sar_year'], kwargs['base_year']))
            ...
            if  not out_files_present:
                ...
                c_dict['tmp_dir'] = os.path.join(kwargs['tmp_dir'], "{}_{}_base{}_apply_chng_thres".format(tile_basename, kwargs['sar_year'], kwargs['base_year']))
        ...
        for l1_year in years_l1:
            ...
            for chg_year in chng_years:
                ...
                self.gen_command_info(gmw_tiles='/scratch/a.pfb/gmw_v3_change/data/gmw_chng_data/from2010/gmw_base2010_mng_{}_v3/*.kea'.format(l1_year),
                                      ...
                                      sar_year=chg_year,
                                      base_year=l1_year,
                                      thres_files_dir=os.path.join(base_dir, 'fnl_prj_thresholds'),
                                      out_dir=os.path.join(base_dir, 'gmw_{}_{}_chngs'.format(l1_year, chg_year)),
                                      tmp_dir='/scratch/a.pfb/gmw_v3_change/tmp')

        self.pop_params_db()
        self.create_slurm_sub_sh("gmw_XXXX_XXXX_chngs", 16448, '/scratch/a.pfb/gmw_v3_change/logs',
