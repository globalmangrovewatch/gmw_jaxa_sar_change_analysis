...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def run_gen_commands(self):
        self.gen_command_info(prjs_lut_file='/scratch/a.pfb/gmw_v3_change/scripts/03_prepare_datasets/09_create_project_tile_lut/gmw_projects_luts.json',
                              pxl_data_dir='/scratch/a.pfb/gmw_v3_change/data/gmw_chng_data/gmw_2010_2015_pxl_vals',
                              sar_year='2015',
                              out_dir='/scratch/a.pfb/gmw_v3_change/data/gmw_chng_data/gmw_2010_2015_prj_thres',
                              tmp_dir='/scratch/a.pfb/gmw_v3_change/tmp')
        self.pop_params_db()
        self.create_slurm_sub_sh("gmw_2010_2015_prj_thres", 16448, '/scratch/a.pfb/gmw_v3_change/logs',
