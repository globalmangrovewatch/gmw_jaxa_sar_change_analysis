...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def run_gen_commands(self):
        self.gen_command_info(gmw_tiles='/scratch/a.pfb/gmw_v3_change/data/gmw_baseline/gmw_2010_v3/*.kea',
                              chng_img_dir='/scratch/a.pfb/gmw_v3_change/data/gmw_chng_data/gmw_2010_2017_chngs',
                              potent_chng_msk_dir='/scratch/a.pfb/gmw_v3_change/data/gmw_baseline/gmw_2010_fnl_potent_chg_rgn',
                              sar_year='2017',
                              out_dir='/scratch/a.pfb/gmw_v3_change/data/gmw_chng_data/gmw_init_2017_v3')
        self.pop_params_db()
        self.create_slurm_sub_sh("gmw_init_2017_v3", 16448, '/scratch/a.pfb/gmw_v3_change/logs',
