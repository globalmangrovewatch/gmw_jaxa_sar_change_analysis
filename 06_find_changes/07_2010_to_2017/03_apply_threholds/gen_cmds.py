...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def run_gen_commands(self):
        self.gen_command_info(gmw_tiles='/scratch/a.pfb/gmw_v3_change/data/gmw_baseline/gmw_2010_v3/*.kea',
                              ...
                              sar_year='2017',
                              thres_files_dir='/scratch/a.pfb/gmw_v3_change/data/gmw_chng_data/gmw_2010_2017_prj_thres',
                              out_dir='/scratch/a.pfb/gmw_v3_change/data/gmw_chng_data/gmw_2010_2017_chngs')
        self.pop_params_db()
        self.create_slurm_sub_sh("gmw_2010_2017_chngs", 16448, '/scratch/a.pfb/gmw_v3_change/logs',
