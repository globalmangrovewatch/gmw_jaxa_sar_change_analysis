...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def run_gen_commands(self):
        self.gen_command_info(img_srch='/scratch/a.pfb/gmw_v3_change/data/gmw_chng_data/gmw_init_2007_v3/*_v3_init.kea',
                              out_lyr_name='gmw_init_2007_v3',
                              out_dir='/scratch/a.pfb/gmw_v3_change/data/gmw_chng_data/gmw_init_2007_v3_vecs')

        self.gen_command_info(img_srch='/scratch/a.pfb/gmw_v3_change/data/gmw_chng_data/gmw_2010_2007_chngs/*2007_mng_chng.kea',
                              out_lyr_name='mng_loss',
                              out_dir='/scratch/a.pfb/gmw_v3_change/data/gmw_chng_data/gmw_init_2007_v3_vecs')

        self.gen_command_info(img_srch='/scratch/a.pfb/gmw_v3_change/data/gmw_chng_data/gmw_2010_2007_chngs/*2007_not_mng_chng.kea',
                              out_lyr_name='mng_gain',
                              out_dir='/scratch/a.pfb/gmw_v3_change/data/gmw_chng_data/gmw_init_2007_v3_vecs')

        self.pop_params_db()
        self.create_slurm_sub_sh("gmw_init_2007_v3_vecs", 16448, '/scratch/a.pfb/gmw_v3_change/logs',
