    ...
    def gen_command_info(self, **kwargs):
        ...
        for gmw_prj in prjs_lut:
            ...
            if len(mng_data_files) > 0:
                thres_file = os.path.join(kwargs['prj_thres_dir'], '{}_{}_chng_thres.json'.format(gmw_prj, kwargs['sar_year']))
                out_cmp_file = os.path.join(kwargs['out_dir'], '{}_{}_chng_plots_cmp.txt'.format(gmw_prj, kwargs['sar_year']))
                ...
                if (not os.path.exists(out_cmp_file)):
                    ...
                    c_dict['thres_file'] = thres_file
                    c_dict['out_dir'] = kwargs['out_dir']
                    c_dict['out_cmp_file'] = out_cmp_file
                    c_dict['tmp_dir'] = os.path.join(kwargs['tmp_dir'], "{}_{}_chng_plot".format(gmw_prj, kwargs['sar_year']))
...
if __name__ == "__main__":
    py_script = os.path.abspath("create_img_tile_plots.py")
    script_cmd = "singularity exec --bind /scratch/a.pfb:/scratch/a.pfb --bind /home/a.pfb:/home/a.pfb /scratch/a.pfb/sw_imgs/au-eoed-dev.sif python {}".format(py_script)

    process_tools_mod = 'create_img_tile_plots'
    process_tools_cls = 'CreateImageTilePlots'
