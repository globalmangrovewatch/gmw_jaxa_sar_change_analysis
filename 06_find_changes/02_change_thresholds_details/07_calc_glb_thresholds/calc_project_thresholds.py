...
class CalcProjectThreholds(PBPTQProcessTool):
    ...
    def do_processing(self, **kwargs):
        ...
        out_thres_lut['his_mng_hh'] = float(calc_kurt_skew_threshold(data, max_val=-1000, min_val=-2200, init_thres=-1400, low_thres=True, contamination=10.0))
        ...
        out_thres_lut['his_nmng_hh'] = float(calc_kurt_skew_threshold(data, max_val=-1000, min_val=-2200, init_thres=-1400, low_thres=False, contamination=10.0))
        ...
        out_thres_lut['his_mng_hv'] = float(calc_kurt_skew_threshold(data, max_val=-1200, min_val=-2400, init_thres=-1600, low_thres=True, contamination=10.0))
        ...
        out_thres_lut['his_nmng_hv'] = float(calc_kurt_skew_threshold(data, max_val=-1200, min_val=-2400, init_thres=-1600, low_thres=False, contamination=10.0))
