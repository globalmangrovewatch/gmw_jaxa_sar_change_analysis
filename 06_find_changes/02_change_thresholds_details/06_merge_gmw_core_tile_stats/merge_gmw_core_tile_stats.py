...
for tile in tiles_idx_lst:
    for year in years:
        tile_lut_dir = '/Users/pete/Temp/gmw_v3_analysis/jaxa_sar_timeseries_analysis/gmw_core_tile_stats/gmw_core_{}_tile_sar_stats'.format(year)

        tile_stats_file = os.path.join(tile_lut_dir, "GMW_{}_{}_mng_dB_stats.json".format(tile, year))
...
gdf_tiles_rslt.to_file('gmw_core_sar_tile_stats.gpkg', layer='gmw_core_sar_tile_stats', driver='GPKG')
...
xls_writer = pandas.ExcelWriter('gmw_core_sar_tile_stats.xlsx', engine='xlsxwriter')
