...
gmw_extent_lut_base = "/bigdata/globalmangrovewatch/gmw_v{0}_extent/gmw_scns_lut_v{0}.gpkg"
...
for version in versions:
    gmw_extent_lut = gmw_extent_lut_base.format(version)
    ...
    for bbox, roi_id in zip(bboxs, roi_ids):
        ...
        for year in gmw_years:
            ...
            out_img = os.path.join(gmw_info[year]["out_dir"], f"gmw_{year}_v{version}_site_{roi_id}.kea")
