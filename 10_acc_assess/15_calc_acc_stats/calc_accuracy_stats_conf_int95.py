...
n_vec_files = len(acc_set_vld_files)
...
out_dir = "out_acc_stats_conf_int"
if not os.path.exists(out_dir):
    os.mkdir(out_dir)



acc_culm_pts_lst_iters = list()
culm_n_pts_lst_iters = list()
acc_stats_dict_iters = dict()
acc_stats_dict_iters["Mangroves"] = list()
acc_stats_dict_iters["Mangroves > Not Mangroves"] = list()
acc_stats_dict_iters["Not Mangroves"] = list()
...
for i in range(10):
    ...
    culm_n_pts_lst_iters.append(list())

    acc_stats_dict_iters["Mangroves"].append(list())
    acc_stats_dict_iters["Mangroves > Not Mangroves"].append(list())
    acc_stats_dict_iters["Not Mangroves"].append(list())
    acc_stats_dict_iters["Not Mangroves > Mangroves"].append(list())
    acc_stats_dict_iters["Overall"].append(list())
    ...
    for acc_pts_file in acc_set_vld_files:
        ...
        acc_stats_dict_iters["Mangroves"][i].append(c_acc_stats_dict["Mangroves"])
        if "Mangroves > Not Mangroves" in c_acc_stats_dict:
            acc_stats_dict_iters["Mangroves > Not Mangroves"][i].append(c_acc_stats_dict["Mangroves > Not Mangroves"])
        else:
            tmp_stats = dict()
            ...
            acc_stats_dict_iters["Mangroves > Not Mangroves"][i].append(tmp_stats)
        acc_stats_dict_iters["Not Mangroves"][i].append(c_acc_stats_dict["Not Mangroves"])
        if "Not Mangroves > Mangroves" in c_acc_stats_dict:
            acc_stats_dict_iters["Not Mangroves > Mangroves"][i].append(c_acc_stats_dict["Not Mangroves > Mangroves"])
        else:
            tmp_stats = dict()
            tmp_stats["f1-score"] = 0.0
            tmp_stats["precision"] = 0.0
            tmp_stats["recall"] = 0.0
            tmp_stats["support"] = 0.0
            acc_stats_dict_iters["Not Mangroves > Mangroves"][i].append(tmp_stats)
        acc_stats_dict_iters["Overall"][i].append(c_acc_stats_dict["accuracy"])
        culm_n_pts_lst_iters[i].append(culm_n_pts)

#print(acc_stats_dict["Overall"])
#print(culm_n_pts_lst)

out_info = dict()
out_info["n_pts_iters"] = culm_n_pts_lst_iters
out_info["acc_stats_iters"] = acc_stats_dict_iters

rsgislib.tools.utils.write_dict_to_json(out_info, "gmw_chng_acc_stats_pt_smpls_conf_int_iters.json")
